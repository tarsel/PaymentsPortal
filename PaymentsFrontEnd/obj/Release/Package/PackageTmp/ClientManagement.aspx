<%@ Page Title="" Language="C#" MasterPageFile="~/Admin.Master" AutoEventWireup="true" CodeBehind="ClientManagement.aspx.cs" Inherits="PaymentsFrontEnd.ClientManagement" %>
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            ...
                            <div class="form-group">
                                <asp:TextBox ID="txtClientName" runat="server" class="form-control" placeholder="Client Name" CausesValidation="true"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="txtPhoneNumber" runat="server" class="form-control" placeholder="Phone Number" CausesValidation="true"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="txtEmail" runat="server" class="form-control" placeholder="Email" CausesValidation="true"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <asp:TextBox ID="txtAddress" runat="server" class="form-control" placeholder="Address" CausesValidation="true"></asp:TextBox>
                            </div>

                            <div class="form-group row">
                                <div class="col-md-9 col-sm-9  offset-md-3">
                                    <asp:Button ID="btnCancelClient" runat="server" Text="Cancel" class="btn btn-primary" OnClick="btnCancelClient_Click" CausesValidation="false" />
                                    <asp:Button ID="btnCreateClient" runat="server" Text="Submit" class="btn btn-success" OnClick="btnCreateClient_Click" />
                ...
                <div class="ibox-content" style="overflow: scroll;">
                    <asp:GridView ID="gvClientSetup" runat="server" class="table table-striped" AllowPaging="true" PageSize="10" DataKeyNames="ClientSettingId" AutoGenerateColumns="False" OnRowCancelingEdit="gvClientSetup_RowCancelingEdit" OnRowEditing="gvClientSetup_RowEditing" OnRowDataBound="gvClientSetup_RowDataBound" OnPageIndexChanging="gvClientSetup_PageIndexChanging" OnRowUpdating="gvClientSetup_RowUpdating">
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="Client Name">
                                <EditItemTemplate>
                                    <asp:Label ID="lblClientName" runat="server" Text='<%# Bind("ClientId") %>' Visible="false">        </asp:Label>
